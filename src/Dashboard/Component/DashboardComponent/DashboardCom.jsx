...
const Verify = React.lazy(()=> import("../Verify & Add/Verify") )
  ...
  const dataArray = [
    {
      ...
      level: "Beginner",
      linkRedirect:
        "https://wa.me/+919801907094?text=I+want+to+start+learn+Python+For+begineers",
    },
    {
      ...
      level: "Beginner",
      linkRedirect:
        "https://wa.me/+919801907094?text=I+want+to+start+learn+Web+Development",
    },
    {
      ...
      level: "Beginner",
      linkRedirect:
        "https://wa.me/+919801907094?text=I+want+to+start+learn+React",
    },
    {
      heading: "React (Frontend)",
      desc: "In this course, we will learn everything about Python, from basics to advanced. So if you are a complete beginner, we..",
      ...
      <div className="w-full bg-white rounded-xl h-[354px] overflow-hidden ">
        ...
        <div className="w-full we flex items-center justify-start gap-4 ml-3 mt-3 overflow-hidden overflow-x-auto scrollbar-hide">
          {dataArray.map((item, index) => (
            <Courses
              redirectLink={item.linkRedirect}
              desc={item.desc}
