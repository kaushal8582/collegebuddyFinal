      ...
      <div className="footer-content w-full h-[400px] border-b-2 border-t-2 border-black pt-[50px] flex justify-between items-start">
        <div className="fsec1 flex flex-col justify-start items-start gap-[25px]">
          ...
          <div className="social-links flex items-center justify-center gap-[10px]">
            <a href="https://discord.com/invite/BJzjcN5Awt" target='_blank'> <img src= {discordSvg} alt="discord"  className="w-[40px] h-[40px]" /> </a>
            <a href="https://www.instagram.com/collegebuddy.in/" target='_blank'><img src= {instagramSvg}  alt="instagram" className="w-[40px] h-[40px]" /></a>
            <a href="https://www.linkedin.com/company/college-buddy-in/" target='_blank' ><img src= {linkdinSvg} alt="linkdin" className="w-[40px] h-[40px]" /></a>
            <a href="https://x.com/CollegeBuddy_in" target='_blank'><img src={xSvg} alt="x" className="w-[40px] h-[40px]" /></a>
            <a href="https://www.youtube.com/@college-buddy" target='_blank'><img src= {youtubeSvg} alt="youtube" className="w-[40px] h-[40px]" /></a>
          </div>
        </div>
        <div className="fsec2 flex flex-col justify-start items-start gap-[25px]">
          ...
          <ol className="flex flex-col justify-start items-start gap-[25px]">
            ...
            <Link to={"/team"}><li className="relative cursor-pointer capitalize">our team</li></Link>
        ...
        <div className="fsec3 flex flex-col justify-start items-start gap-[25px]">
          ...
          <ol className="flex flex-col justify-start items-start gap-[25px]">
            <a href="https://chat.whatsapp.com/LpmIxWmdZR5JHxeNMGCgTc" target='_blank'><li className="relative cursor-pointer capitalize">WhatsApp</li></a>

            <a href="https://discord.com/invite/BJzjcN5Awt"><li className="relative cursor-pointer capitalize">discord</li></a>
          </ol>
        </div>
